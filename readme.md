...
Items in exclude array matches part of the rel in the panel. 
E.g. string 'Tracy-dumps' activates an exception for the panel with rel 'tracy-debug-panel-Tracy-dumps' in the main bar. For the others (ajax, redirect) it matches 'tracy-debug-panel-Tracy-dumps-...'
